...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-14 13:09`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f4795c81-c4c3-4b75-963a-cd56d4ba290c.git
$ cd f4795c81-c4c3-4b75-963a-cd56d4ba290c
```
